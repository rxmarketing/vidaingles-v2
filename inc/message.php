...
<p>	Los siento, hubo un error al tratar de activar tu cuenta. Se nos ha notificado sobre este problema y nos pondremos en contacto contigo por email cuando se resuelva.</p>';
	...
	$message = '<div class="text-success bg-success"><h2>&iexcl;Enhorabuena!</h2> <p>Tu cuenta en Vida Inglés ha sido activada. <a href="http://vidaingles.com/iniciar">Clic aqui para iniciar sesión</a></p></div>';
} else {
	$message = $msg;
}
?>
