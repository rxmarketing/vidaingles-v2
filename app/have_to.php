...
<html lang="es" translate="no">
	<head>
		<title>have to (obligacion) Exercise</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title"         content="'have to' (obligación externa)" />
		<meta property="og:description"   content="Ejercicio: Escribe frases con 'have to' o 'has to'." />
		<meta property="og:image"         content="" />
		<meta name="keywords" content="have to, obligacion, externa, clases ingles, lecciones ingles, vida ingles" />
		<meta name="description" content="Ejercicio: Escribe frases con 'have to' o 'has to'.">
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3><em>have to</em> <small>(obligación externa)</small></h3>
							...
							<h4>1. Escribe oraciones con <em>have to</em> <b>Positivo</b></h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">She / do / her homework right now.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2">We / study / for the exam.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3">My cat / take / its medecine.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">Mary and Alice / sleep / in the spare room.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">I / wait / three hours.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q6">She / not do / her homework right now.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">We / not study / for the exam.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">My cat / not take / its medecine.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9">Mary and Alice / not sleep / in the spare room.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10">I / not wait / three hours.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q11">She / do / her homework right now?</label>
								...
								<li>
									<div class="form-group">
										<label for="q14">We / study / for the exam?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17">My cat / take / its medecine?</label>
								...
								<li>
									<div class="form-group">
										<label for="q20">Mary and Alice / sleep / in the spare room?</label>
								...
								<li>
									<div class="form-group">
										<label for="q23">I / wait / three hours?</label>
		...
		<script async src="js/have_to.js"></script>
	</body>
</html>