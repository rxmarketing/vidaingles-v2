...
<html lang="es" translate="no">
	<head>
		<title>Present Perfect Exercise</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title"         content="Presente Perfecto Simple" />
		<meta property="og:description"   content="Ejercicio: Escribe frases en 'presente perfecto simple'." />
		<meta property="og:image"         content="" />
		<meta name="keywords" content="present perfecto simple, presente, perfecto, simple, clases ingles, lecciones ingles, vida ingles" />
		<meta name="description" content="Ejercicio: Escribe frases en 'presente perfecto simple'.">
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3>Presente Perfecto Simple</h3>
							...
							<h4>1. Escribe oraciones en presente perfecto simple <b>Positivo</b></h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">The students / do / their exercise.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2">John / take / the bus downtown.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3">Cortana and her sister / try / Sushi.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">I / see / them together.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">Children / learn / to use computers at school.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q6">The students / do / their exercise.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">John / take / the bus downtown.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">Cortana and her sister / try / Sushi.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9">I / see / them together.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10">Children / learn / to use computers at school.</label>
										<input type="text" class="form-control" id="q10" placeholder="">
									</div>
								</li>
							</ol>
							<h4>3. Escribe las mismas oraciones en la forma <b>Interrogativa</b>. Responde en forma negativa y positiva. <small>Usa contracciones donde se pueda.</small></h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q11">The students / do / their exercise?</label>
								...
								<li>
									<div class="form-group">
										<label for="q14">John / take / the bus downtown?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17">Cortana and her sister / try / Sushi?</label>
								...
								<li>
									<div class="form-group">
										<label for="q20">You / see / them together?</label>
								...
								<li>
									<div class="form-group">
										<label for="q23">Children / learn / to use computers at school?</label>
		...
		<script async src="js/present-perfect.js"></script>
	</body>
</html>