...
<html lang="es" translate="no">
	<head>
		<title>Presente Simple Contínuo</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title"         content="Present Simple Contínuo" />
		<meta property="og:description"   content="Ejercicio: Escribe oraciones en 'presente simple contínuo'." />
		<meta property="og:image"         content="" />
		<meta name="keywords" content="presente, simple, contínuo, continuo, clases ingles, lecciones ingles, vida ingles" />
		<meta name="description" content="Ejercicio: Escribe oraciones en 'presente simple contínuo'.">
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3>Presente Simple Contínuo</h3>
							...
							<h4>1. Escribe oraciones en <em>presente simple contínuo</em> <b>positivo</b></h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">My dad / eat / a cake right now.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2">The dog / run / in the garden.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3">I / go / to the cinema right now.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">Tom and Jane / meet / at 5 pm.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">My sister and I / watch / a movie.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q6">My dad / not eat / a cake right now.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">The dog / not run / in the garden.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">I / not go / to the cinema right now.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9">Tom and Jane / not meet / at 5 pm.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10">My sister and I / not watch / a movie..</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q11">My dad / eat / a cake right now?</label>
								...
								<li>
									<div class="form-group">
										<label for="q14">The dog / run / in the garden?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17">I / go / to the cinema right now?</label>
								...
								<li>
									<div class="form-group">
										<label for="q20">Tom and Jane / meet / at 5 pm?</label>
								...
								<li>
									<div class="form-group">
										<label for="q23">My sister and I / watch / a movie?</label>
		...
		<script async src="js/present_continuous.js"></script>
	</body>
</html>