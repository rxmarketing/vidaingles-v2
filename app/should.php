...
<html lang="es" translate="no">
    ...
    <meta property="og:title"         content="should (consejos)" />
    <meta property="og:description"   content="Ejercicio: Escribe frases con el verbo modal should. Dar consejos." />
    <meta property="og:image"         content="" />
		<meta name="keywords" content="should, verbo modal should, dar consejos, consejo, clases ingles, lecciones ingles, vida ingles" />
    <meta name="description" content="Ejercicio: Escribe frases con el verbo modal should. Dar consejos.">
	...
	<body>
			...
			<div class="row">
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3>should <small>(para dar consejos)</small></h3>
							...
							<h4>1. Escribe oraciones con <em>should</em> <b>Positivo</b></h4> 
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">They / take / the bus to school.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2">I / learn / how to drive.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3">You / be / more careful.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">My parents / take / a holiday this year.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">Ana and Cecilia / do / more exercise.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q6">They / not take / the bus to school.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">I / not learn / how to drive.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">You / not be / more careful.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9">My parents / not take / a holiday this year.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10">Ana and Cecilia / not do / more exercise.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q11">They / take / the bus to school?</label>
								...
								<li>
									<div class="form-group">
										<label for="q14">I / learn / how to drive?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17">You / be / more careful?</label>
								...
								<li>
									<div class="form-group">
										<label for="q20">My parents / take / a holiday this year?</label>
								...
								<li>
									<div class="form-group">
										<label for="q23">Ana and Cecilia / do / more exercise?</label>
		...
		<script async src="js/should.js"></script>
	</body>
</html>