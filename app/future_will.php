...
<html lang="es" translate="no">
	<head>
		<title>Futuro con will (predicciones, promesas)</title>
		<meta charset="UTF-8">
    ...
    <meta property="og:title"         content="Futuro con 'will' (predicciones, promesas)" />
    <meta property="og:description"   content="Ejercicio: Escribe frases en futuro con el verbo modal 'will' seguido por la forma base del verbo." />
    <meta property="og:image"         content="" />
		<meta name="keywords" content="will, verbo modal will, predicciones, promesas, clases ingles, lecciones ingles, vida ingles" />
    <meta name="description" content="Ejercicio: Escribe frases en futuro con el verbo modal 'will' seguido por la forma base del verbo.">
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3>Futuro con <em>will</em> <small>(predicciones, promesas)</small></h3>
							...
							<h4>1. Escribe frases en futuro con <em>will</em>.</h4> 
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">Tina / help / you.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2">You / have / to wait.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3">She / come / and see me this weekend.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">The dog / hurt / you.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">I / give / you / my laptop.</label>
							...
							<ol>
								<li>
									<div class="form-group">
										<label for="q6">Tina / not help / you.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">You / not have / to wait.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">She / not come / and see me this weekend.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9">The dog / not hurt / you.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10">I / not give / you / my laptop.</label>
										<input type="text" class="form-control" id="q10" placeholder="">
									</div>
								</li>
							</ol>
							<h4>3. Escribe oraciones en la forma <b>Interrogativa</b>. Responde en forma positiva y negativa</h4>.
							<ol>
								<li>
									<div class="form-group">
										<label for="q11">Tina / help / me?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17">She / come / and see me this weekend?</label>
		...
		<script async src="js/future_will.js"></script>
	</body>
</html>		