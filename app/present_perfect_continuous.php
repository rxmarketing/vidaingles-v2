...
<html lang="es" translate="no">
	<head>
		<title>Presente Perfecto Contínuo</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title"         content="Presente Perfecto Contínuo" />
		<meta property="og:description"   content="Ejercicio: Escribe frases y preguntas en 'presente perfecto contínuo'." />
		<meta property="og:image"         content="" />
		<meta name="keywords" content="presente perfecto continuo, present perfect continuous, perfecto, contínuo, clases ingles, lecciones ingles, vida ingles" />
		<meta name="description" content="Ejercicio: Escribe frases y preguntas en 'presente perfecto contínuo'.">
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3>Presente Perfecto Contínuo</h3>
							...
							<h4>1. Escribe oraciones en presente perfecto continuo <b>positivo</b></h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q1">My dad / do / exercise for three months.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2">Jessica / look / for her mobile phone all day.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3">Xiomara and her cat / sleep / since seven o'clock.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4">We / expect / our parents for dinner for too long.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5">I / work / all day today.</label>
										<input type="text" class="form-control" id="q5" placeholder="">
									</div>
								</li>
							</ol>
							<h4>2. Escribe las mismas oraciones en la forma <b>negativa</b></h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q6">My dad / not do / exercise for three months.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7">Jessica / not look / for her mobile phone all day.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8">Xiomara and her cat / not sleep / since seven o'clock.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9">We / not expect / our parents for dinner for too long.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10">I / not work / all day today.</label>
										<input type="text" class="form-control" id="q10" placeholder="">
									</div>
								</li>
							</ol>
							<h4>3. Escribe las mismas oraciones en la forma <b>interrogativa</b>. Responde en forma negativa y positiva.</h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q11">My dad / do / exercise for three months?</label>
								...
								<li>
									<div class="form-group">
										<label for="q14">Jessica / look / for her mobile phone all day?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17">Xiomara and her cat / sleep / since seven o'clock?</label>
								...
								<li>
									<div class="form-group">
										<label for="q20">We / expect / our parents for dinner for too long?</label>
								...
								<li>
									<div class="form-group">
										<label for="q23">You / work / all day today?</label>
		...
		<script async src="js/present_perfect_continuous.js"></script>
	</body>
</html>