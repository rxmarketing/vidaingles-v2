...
<html lang="es" translate="no">
	<head>
		<title>Presente Simple del Verbo be</title>
		<meta charset="UTF-8">
		...
		<meta property="og:title"         content="Presente Simple del verbo be." />
		<meta property="og:description"   content="Ejercicio: Escribe frases con el 'presente simple del verbo be'." />
		<meta property="og:image"         content="" />
		<meta name="keywords" content="presente simple, verbo, be, present, clases ingles, lecciones ingles, vida ingles" />
		<meta name="description" content="Ejercicio: Escribe frases con el 'presente simple del verbo be'.">
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-9 marketing">
					<section>
						<h1>Ejercicios</h1>
						<form role="form">
							<h3>Presente Simple del Verbo <em>be</em></h3>
							...
							<h4>1. Escribe frases con el presente simple del verbo <em>be</em> forma <b>positiva</b>.</h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q1"><span class="subject">Our house</span> / <span class="verb">be</span> / <span class="compl">big</span>.</label>
										<input type="text" class="form-control" id="q1" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q2"><span class="subject">The duck</span> / <span class="verb">be</span> / <span class="compl">in the water</span>.</label>
										<input type="text" class="form-control" id="q2" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q3"><span class="subject">I</span> / <span class="verb">be</span> / <span class="compl">at home right now</span>.</label>
										<input type="text" class="form-control" id="q3" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q4"><span class="subject">Rebeca and I</span> / <span class="verb">be</span> / <span class="compl">happy</span>.</label>
										<input type="text" class="form-control" id="q4" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q5"><span class="subject">Their car</span> / <span class="verb">be</span> / <span class="compl">very old</span>.</label>
										<input type="text" class="form-control" id="q5" placeholder="">
									</div>
								</li>
							</ol>
							<h4>2. Escribe frases con el presente simple del verbo <em>be</em> forma <b>negativa</b>.</h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q6"><span class="subject">Dolphins</span> / not <span class="verb">be</span> / <span class="compl">dangerous creatures</span>.</label>
										<input type="text" class="form-control" id="q6" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q7"><span class="subject">My mobile phone</span> / not <span class="verb">be</span> / <span class="compl">cheap</span>.</label>
										<input type="text" class="form-control" id="q7" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q8"><span class="subject">We</span> / not <span class="verb">be</span> / <span class="compl">related</span>.</label>
										<input type="text" class="form-control" id="q8" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q9"><span class="subject">I</span> / not <span class="verb">be</span> / <span class="compl">from Switzerland</span>.</label>
										<input type="text" class="form-control" id="q9" placeholder="">
									</div>
								</li>
								<li>
									<div class="form-group">
										<label for="q10"><span class="subject">She</span> / not <span class="verb">be</span> / <span class="compl">twenty-five years old</span>.</label>
										<input type="text" class="form-control" id="q10" placeholder="">
									</div>
								</li>
							</ol>
							<h4>3. Escribe preguntas con el presente simple del verbo <em>be</em>. Responde en forma positiva y negativa.</h4>
							<ol>
								<li>
									<div class="form-group">
										<label for="q11"><span class="subject">You</span> / <span class="verb">be</span> / <span class="compl">nineteen</span>?</label>
								...
								<li>
									<div class="form-group">
										<label for="q14"><span class="subject">The radio</span> / <span class="verb">be</span> / <span class="compl">on</span>?</label>
								...
								<li>
									<div class="form-group">
										<label for="q17"><span class="subject">Alicia and Gaby</span> / <span class="verb">be</span> / <span class="compl">sisters</span>?</label>
								...
								<li>
									<div class="form-group">
										<label for="q20"><span class="subject">He</span> / <span class="verb">be</span> / <span class="compl">Irish</span>?</label>
								...
								<li>
									<div class="form-group">
										<label for="q23"><span class="subject">Your dad</span> / <span class="verb">be</span> / <span class="compl">at work</span>?</label>
		...
		<script async src="js/present_simple_be.js"></script>
	</body>
</html>