...
if (isset($_FILES["avatar"]["name"]) && $_FILES["avatar"]["tmp_name"] != ""){
	...
	$sql = "SELECT avatar FROM usuarios WHERE username='$log_username' LIMIT 1";
	...
	include_once("../ajax/ajax_photo_resize.php");
	$target_file = "../users/$log_username/$db_file_name";
	$resized_file = "../users/$log_username/$db_file_name";
	$wmax = 200;
	$hmax = 300;
	img_resize($target_file, $resized_file, $wmax, $hmax, $fileExt);
	$sql = "UPDATE usuarios SET avatar='$db_file_name' WHERE username='$log_username' LIMIT 1";
	$query = mysqli_query($db_conx, $sql);
